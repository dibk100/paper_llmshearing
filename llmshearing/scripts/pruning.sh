...
DATA_DIR='/home/dibaeck/sketch/LLM-Shearing/llmshearing/data/mds_sample_redpajama/for_prune'
OUTPUT_DIR='/home/dibaeck/sketch/LLM-Shearing/out/test_release_pruning_full'
TRAIN_SCRIPT=${PROJ_DIR}/llmshearing/train.py
MODEL_PATH='/home/dibaeck/sketch/LLM-Shearing/llmshearing/models/Llama-2-7b-composer'   # ?
...
composer $TRAIN_SCRIPT $config_file \
    run_name=${run_name} \
